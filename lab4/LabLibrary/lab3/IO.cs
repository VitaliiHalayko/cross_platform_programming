...
namespace lab3
{
    ...
    {
        public static (int width, int height, char[,] field, List<int[]> coords) readDataFromFile(string inputFilePath)
        {
        ...
        public static void writeResultsToFile(string outputFilePath, List<int> results)
		{
			if (results.Count == 0)
			{
		...
		public static void writeErrorToFile(string outputFilePath, string message)
		{
